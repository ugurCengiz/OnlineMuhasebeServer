...
using System.Text;
using AppDbContext = OnlineMuhasebeServer.RabbitMQ.Context.AppDbContext;
...
namespace OnlineMuhasebeServer.RabbitMQ
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            factory.Uri =
                new Uri("amqps://aewmosbk:GNGYwoF1XCultQcDUdWPsnmZ1tSyGtwF@sparrow.rmq.cloudamqp.com/aewmosbk");
        ...
        public static void CreateUCAFExcel(ReportDto reportDto)
        {
            ...
            IList<UniformChartOfAccount> ucafs =
                companyDbContext.Set<UniformChartOfAccount>().OrderBy(p => p.Code).ToList();
            string fileName = "";
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                string filePath =
                    $"C:/Users/UĞUR/Desktop/YEDEKLERRR/DERSNOTLARI/TANERSAYDAM/OnlineMuhasebeClient/src/assets/reports/{fileName}";
